...
bool OpenGL4Object::InitialiseOpenGL4Object(HWND hwnd, int screenWidth, int screenHeight, float screenDepth, float screenNear, bool isVsyncEnabled)
{
...
void OpenGL4Object::Shutdown(HWND hwnd)
{
...
void OpenGL4Object::BeginScene(float red, float green, float blue, float alpha)
{
...
bool OpenGL4Object::LoadExtensionList() 
{
...
void OpenGL4Object::GetWorldMatrix(float* matrix)
{
...
void OpenGL4Object::GetProjectionMatrix(float* matrix)
{
...
void OpenGL4Object::GetVideoCardInfo(char* cardName)
{
...
void OpenGL4Object::BuildIdentityMatrix(float* matrix)
{
	matrix[0] = 1.0f;
	matrix[1] = 0.0f;
	matrix[2] = 0.0f;
...
void OpenGL4Object::BuildPerspectiveFovLHMatrix(float* matrix, float fieldOfView, float screenAspect, float screenNear, float screenDepth)
{
...
void OpenGL4Object::MatrixTranslation(float* matrix, float x, float y, float z)
{
	matrix[0] = 1.0f;
	matrix[1] = 0.0f;
	matrix[2] = 0.0f;
...
void OpenGL4Object::MatrixMultiply(float* result, float* matrix1, float* matrix2)
{
