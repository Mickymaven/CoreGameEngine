#include "OpenGL4TextureShader.h"

OpenGL4TextureShader::OpenGL4TextureShader()
{
}

OpenGL4TextureShader::OpenGL4TextureShader(const OpenGL4TextureShader &)
{
}
...
bool OpenGL4TextureShader::ShaderInitialize(OpenGL4Object * openGL, HWND hwnd)
{
	bool result;

	result = InitializeShader("Resources/Shaders/textureVS.glsl", "Resources/Shaders/texturePS.glsl", openGL, hwnd);
	//result = InitializeShader("Resources/Shaders/texture.vs", "Resources/Shaders/texture.ps", openGL, hwnd);
...
void OpenGL4TextureShader::Shutdown(OpenGL4Object * openGL)
{
...
void OpenGL4TextureShader::SetShader(OpenGL4Object * openGL)
{
...
bool OpenGL4TextureShader::InitializeShader(char *vsFilename, char * fsFilename, OpenGL4Object * openGL, HWND hwnd)
{
...
char * OpenGL4TextureShader::LoadShaderSourceFile(char * filename)
{
	ifstream fin;
	int fileSize;
	char input;
...
void OpenGL4TextureShader::OutputShaderErrorMessage(OpenGL4Object * openGL, HWND hwnd, unsigned int shaderId, char * shaderFilename)
{
	int logSize, i;
	char * infoLog;
	ofstream fout;
...
void OpenGL4TextureShader::OutputLinkerErrorMessage(OpenGL4Object * openGL, HWND hwnd, unsigned int programId)
{
	int logSize, i;
	char * infoLog;
	ofstream fout;
...
void OpenGL4TextureShader::ShutdownShader(OpenGL4Object * openGL)
{
...
bool OpenGL4TextureShader::SetShaderParameters(OpenGL4Object * openGL, float * worldMatrix, float * viewMatrix, float * projectionMatrix, int textureUnit)
{
